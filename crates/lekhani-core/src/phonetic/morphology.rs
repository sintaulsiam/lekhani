...
pub const COLLOQUIAL_VERBAL_PATTERNS: &[(&str, &[&str])] = &[
    ...
    ("chen", &["ছেন", "তেছেন"]),
    ("cheni", &["ছেনi", "তেছেন"]),
    // Spoken Continuous / Double-S (-ssi, -sse, -sso, -ssen, -ssilam, -ssilo)
    ("ssilam", &["চ্ছিলাম", "ছিলাম", "েছিলাম"]),
    ("ssilen", &["চ্ছিলেন", "ছিলেন", "েছিলেন"]),
    ("ssilo", &["চ্ছিল", "ছিল", "েছিল"]),
    ("ssila", &["চ্ছিলা", "ছিলা", "েছিলা"]),
    ("ssen", &["চ্ছেন", "ছেন", "েছেন"]),
    ("sso", &["চ্ছো", "ছো", "েছো"]),
    ("sse", &["চ্ছে", "ছে", "েছে"]),
    ("ssi", &["চ্ছি", "ছি", "েছি"]),
