...
1. **Installer Setup:** Download and run `Lekhani-v1.0.0-Setup.exe` from Releases.
2. **Portable ZIP:** Extract `lekhani-v1.0.0-windows-x86_64.zip` and run `START_LEKHANI.bat` or `lekhani-gui.exe`.
